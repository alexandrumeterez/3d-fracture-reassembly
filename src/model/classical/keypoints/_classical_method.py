...
def f(fragment_path, output_path, keypoint_radius, r_vals, n_keypoints, k, lbd):
	extractor = Extractor(
		fragment_path, output_path, keypoint_radius, r_vals, n_keypoints, k, lbd
	)
	extractor.extract()
...
if __name__ == "__main__":
	...
	parser.add_argument(
		"--fragment1", type=str, default="/Users/alex/2Thingys/135216_8_seed_0/135216_shard_0.npy"
	)
	parser.add_argument(
		"--fragment2", type=str, default="/Users/alex/2Thingys/135216_8_seed_0/135216_shard_2.npy"
	)
	...
	if args.mode == 1:
		...
		extractor1 = Extractor(
			args.fragment1, "temp", r, scales, n_points, args.k, args.lbd, plot_features=False
		)
		extractor1.extract()
		extractor2 = Extractor(
			args.fragment2, "temp", r, scales, n_points, args.k, args.lbd, plot_features=False
		)
		extractor2.extract()
